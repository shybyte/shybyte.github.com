...
this.move(b)}a.prototype.move=function(a){return this.pos=a};a.prototype.updateScreenPos=function(a,b){return this.el.css({left:this.pos.x/a.width*b.width(),top:this.pos.y/a.height*b.height()})};return a}();f=function(){var a,f,h,k,p,s,w,m,v,u,r,t,y,z,A,B,K,C,F,G,L,o,H,D,I,E,J,x;p=jq("#threshold");f=jq("#fadeThresholdImage");k=jq("#markingsSize");a=jq("#mainCanvas");m=a.get(0);B=jq("#filteredCanvas").get(0);r=m.getContext("2d");t=B.getContext("2d");o=[];h=jq("#markings");y="";J=function(){var a;a=
{markingsSize:k.val(),threshold:p.val(),fadeThresholdImage:f.val(),enabledMarkingTypes:e};return localStorage.cell_counter_settings=JSON.stringify(a)};u=function(){var a,b,c,d,f;J();a=$("#markingTypeSelectors");c=C();a.empty();for(d=0,f=e.length;d<f;d++)b=e[d],b='<div>\n<input id="markingTypeSelector'+b+'" type="radio" name="markingType" value="'+b+'">\n<label for="markingTypeSelector'+b+'" class="markingLabel'+b+'">Count: <span id="cellCount'+b+'">0</span></label>\n</div>',a.append(b);a=0<=j.call(e,
c)?c:e[0];$("#markingTypeSelector"+a).prop("checked",!0);return x()};L=function(){var a,b,c,d,e;D();b=JSON.parse(localStorage["cell_counter_markings_data_"+y]||"[]");e=[];for(c=0,d=b.length;c<d;c++)a=b[c],e.push(s(a.pos,a.type));return e};E=function(){var a,b,c,d;d=[];for(b=0,c=o.length;b<c;b++)a=o[b],d.push({pos:a.pos,type:a.type});return localStorage["cell_counter_markings_data_"+y]=JSON.stringify(d)};H=function(){var a,b;a=getCSSRule(".marking");b=k.val();a.style.width=b+"px";a.style.height=b+
"px";a.style.marginLeft=-b/2+"px";return a.style.marginTop=-b/2+"px"};z=function(b){var c,d;d=a.offset();c=b.pageX-d.left;b=b.pageY-d.top;return{x:Math.round(c/a.width()*m.width),y:Math.round(b/a.height()*m.height)}};v=function(){var a,b;a=f.val();a/=128;1>a?b=1:(b=2-a,a=1);jq("#mainCanvas").css("opacity",b);return jq("#filteredCanvas").css("opacity",a)};w=function(a){s(a,C());return E()};C=function(){return jq("input:radio[name=markingType]:checked").val()};s=function(c,d){var e;e=new b(c,d);o.push(e);
h.append(e.el);e.updateScreenPos(m,a);return x()};I=function(a){if(a=K(a.x,a.y))return o=_.without(o,a),a.el.remove(),x(),E()};D=function(){var a,b,c;for(b=0,c=o.length;b<c;b++)a=o[b],a.el.remove();o=[];return x()};x=function(){var a,b,c,d,f,g;b=_.groupBy(o,"type");a=function(a){var c,d;return null!=(c=null!=(d=b[a])?d.length:void 0)?c:0};g=[];for(d=0,f=e.length;d<f;d++)c=e[d],g.push(jq("#cellCount"+c).text(a(c)));return g};K=function(a,b){return _.min(o,function(c){var d;d=c.pos.x-a;c=c.pos.y-b;
return d*d+c*c})};G=function(a){var b;b=new FileReader;b.onload=function(b){F(b.target.result);return y=a.name};return b.readAsDataURL(a)};F=function(a){var b;b=new Image;b.onload=function(){m.width=b.width;m.height=b.height;r.drawImage(b,0,0);L();return A()};return b.src=a};A=function(){var a;B.width=m.width;B.height=m.height;a=Filters.filterCanvas(Filters.thresholdRG,m,{threshold:p.val()});return t.putImageData(a,0,0)};window.FileReader||(alert("No local file reading possible. "+d),jq("#openFile").replaceWith("No local file reading possible. "+
...
a.originalEvent.dataTransfer.files.length)return G(a.originalEvent.dataTransfer.files[0]);if(c)return 1})})();(function(){h.click(function(a){var b;if("marking"===g)return b=z(a),a.ctrlKey&&0<o.length?I(b):w(b)});return h.bind("contextmenu",function(a){a.preventDefault();return I(z(a))})})();(function(){return $("#autoCountButton").click(function(){var a,b,c,d,e;D();a=Filters.compressedGrayScaleFromRed(r.getImageData(0,0,m.width,m.height));a=Filters.meanCGSRepeated(a,4,4);a=Filters.peaksCGS(a,p.val(),
3);b=C();e=a.peaks;for(c=0,d=e.length;c<d;c++)a=e[c],s(a,b);return E()})})();(function(){var b,c,d,e,f;b=$("#helpText");f=null;$("#cropImageLink").click(function(){f=[];g="crop";b.text("Select the top left point!");return b.show("slow")});h.click(function(a){if("crop"===g){f.push(z(a));if(1===f.length)return b.text("Select the bottom right point!");if(1<f.length)return b.hide(),g="marking",e(),c()}});e=function(){var a;if(f[1].x<f[0].x)a=f[0].x,f[0].x=f[1].x,f[1].x=a;if(f[1].y<f[0].y)return a=f[0].y,
f[0].y=f[1].y,f[1].y=a};c=function(){var a,b,c;c=f[1].x-f[0].x;b=f[1].y-f[0].y;a=r.getImageData(f[0].x,f[0].y,c,b);m.width=c;m.height=b;r.putImageData(a,0,0);A();return d()};return d=function(){var b,c,d,e,g,h;for(d=0,e=o.length;d<e;d++)b=o[d],c=b.pos,c={x:c.x-f[0].x,y:c.y-f[0].y},0<(g=c.x)&&g<m.width&&0<(h=c.y)&&h<m.height?(b.move(c),b.updateScreenPos(m,a)):(b.el.remove(),b.removed=!0);g=[];for(d=0,e=o.length;d<e;d++)b=o[d],b.removed||g.push(b);o=g;return x()}})();(function(){var a,b;a=function(a,
b){return a.hide().rangeinput().change(function(){J();return b()})};b=function(b,c){return a(b,c).bind("onSlide",c)};k=b(k,H);p=a(p,A);return f=b(f,v)})();F("images/nora1.jpg");(function(){return jq(window).resize(function(){var b,c,d,e;e=[];for(c=0,d=o.length;c<d;c++)b=o[c],e.push(b.updateScreenPos(m,a));return e})})();$("#removeAllMarkings").click(D);return $("#filterButton").click(function(){var a;a=Filters.filterCanvas(Filters.fastGaussian,m,[0,-1,0,-1,5,-1,0,-1,0]);return r.putImageData(a,0,
0)})};i=function(b){var c;c=$("#enabledMarkingTypesSelector");$("#configureLink").click(function(){var b,d,f,g,h;c.empty();h=[];for(f=0,g=a.length;f<g;f++)d=a[f],b=0<=j.call(e,d)?"checked":"",b='<div>\n<input id="enableMarkingType'+d+'" type="checkbox" value="'+d+'" '+b+'>\n<label for="enableMarkingType'+d+'" class="markingLabel'+d+'">Cell Type '+d+"</label>\n                             </div>",h.push(c.append(b));return h}).overlay({mask:{color:"#ebecff",loadSpeed:200,opacity:0.98},closeOnClick:!1});
