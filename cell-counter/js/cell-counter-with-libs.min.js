...
Filters.convolute=function(a,d,b){for(var c=Math.round(Math.sqrt(d.length)),e=Math.floor(c/2),f=a.data,g=a.width,a=a.height,i=Filters.createImageData(g,a),h=i.data,b=b?1:0,j=0;j<a;j++)for(var o=0;o<g;o++){for(var l=j,q=o,k=4*(j*g+o),s=0,r=0,u=0,w=0,m=0;m<c;m++)for(var v=0;v<c;v++){var t=l+m-e,n=q+v-e;0<=t&&t<a&&0<=n&&n<g&&(t=4*(t*g+n),n=d[m*c+v],s+=f[t]*n,r+=f[t+1]*n,u+=f[t+2]*n,w+=f[t+3]*n)}h[k]=s;h[k+1]=r;h[k+2]=u;h[k+3]=w+b*(255-w)}return i};
Filters.fastGaussian=function(a){for(var d=[0.06,0.061,0.242,0.383,0.242,0.061,0.06],b=a.data,c=a.width,a=a.height,e=Filters.createImageData(c,a).data,f=e,g=0;g<a;g++)for(var i=0;i<c;i++){for(var h=0,j=0,o=0,l=4*(g*c+i-3),q=0;q<d.length;q++){var k=d[q],h=h+b[l++]*k,j=j+b[l++]*k,o=o+b[l++]*k;l++}l=4*(g*c+i);f[l++]=h;f[l++]=j;f[l++]=o;f[l]=255}b=e;e=Filters.createImageData(c,a);f=e.data;for(g=0;g<a;g++)for(i=0;i<c;i++){o=j=h=0;l=4*((g-3)*c+i);for(q=0;q<d.length;q++)var k=d[q]/1.109,s=l+4*q*c,h=h+b[s++]*
k,j=j+b[s++]*k,o=o+b[s]*k;l=4*(g*c+i);f[l++]=h;f[l++]=j;f[l++]=o;f[l]=255}return e};Filters.compressedGrayScaleFromRed=function(a){for(var d=a.data,b=[],c=a.width*a.height,e=0,f=0;f<c;f++)b[f]=d[e],e+=4;return{data:b,width:a.width,height:a.height}};Filters.imageDataFromCompressedGrayScale=function(a){for(var d=Filters.createImageData(a.width,a.height),b=a.data,a=a.width*a.height,c=d.data,e=0,f=0;f<a;f++)c[e]=c[e+1]=c[e+2]=b[f],c[e+3]=255,e+=4;return d};
...
Filters.meanCGSVertical=function(a,d){var b=a.data,c=a.width,e=a.height,f=c*e,g=[];initArray(g,f);for(var i=Math.floor(d/2),h=0;h<c;h++)for(var j=0,o=h-i*c,l=h+(i+1)*c,q=h,k=0;k<e;k++)j=j+(l<f?b[l]:0)-(0<=o?b[o]:0),g[q+c]=j/d,o+=c,l+=c,q+=c;return{data:g,width:a.width,height:a.height}};
...
Filters.peaksCGS=function(a,d,b){var c=a.data,e=a.width,f=a.height,g=[],i=[];initArray(i,e*f);for(var h=0;h<e;h++)for(var j=0;j<f;j++){var o=j*e+h,l=c[o];if(l>=d){i[o]=255;var q=Math.min(h+b,e),k=Math.max(h-b,0);a:for(;k<q;k++)for(var s=Math.min(j+b,f),r=Math.max(j-b,0);r<s;r++)if(l<c[r*e+k]&&(h!=k||j!=r)){i[o]=0;break a}255==i[o]&&g.push({x:h,y:j})}}return{data:i,width:a.width,height:a.height,peaks:g}};
...
this.move(b)}a.prototype.move=function(a){return this.pos=a};a.prototype.updateScreenPos=function(a,b,c){return this.el.css({left:(this.pos.x-c.x)/a.width*b.width(),top:(this.pos.y-c.y)/a.height*b.height()})};return a}();f=function(){var a,f,i,k,s,r,u,w,m,v,t,n,x,O,A,H,B,C,D,E,P,F,I,J,Q,p,K,L,G,M,y,N,z;r=jq("#threshold");f=jq("#fadeThresholdImage");k=jq("#markingsSize");s=$("#restoreOriginalImageLink");H=null;a=jq("#mainCanvas");m=a.get(0);E=jq("#filteredCanvas").get(0);x=m.getContext("2d");O=E.getContext("2d");
n={x:0,y:0};p=[];i=jq("#markings");A="";N=function(){var a;a={markingsSize:k.val(),threshold:r.val(),fadeThresholdImage:f.val(),enabledMarkingTypes:e};return localStorage.cell_counter_settings=JSON.stringify(a)};t=function(){var a,b,c,d,f;N();a=$("#markingTypeSelectors");c=F();a.empty();for(d=0,f=e.length;d<f;d++)b=e[d],b='<div>\n<input id="markingTypeSelector'+b+'" type="radio" name="markingType" value="'+b+'">\n<label for="markingTypeSelector'+b+'" class="markingLabel'+b+'">Count: <span id="cellCount'+
b+'">0</span></label>\n</div>',a.append(b);a=0<=j.call(e,c)?c:e[0];$("#markingTypeSelector"+a).prop("checked",!0);return z()};Q=function(){var a,b,c,d,e;G();b=JSON.parse(localStorage["cell_counter_markings_data_"+A]||"[]");e=[];for(c=0,d=b.length;c<d;c++)a=b[c],e.push(u(a.pos,a.type));return e};y=function(){var a,b,c,d;d=[];for(b=0,c=p.length;b<c;b++)a=p[b],d.push({pos:a.pos,type:a.type});return localStorage["cell_counter_markings_data_"+A]=JSON.stringify(d)};K=function(){var a,b;a=getCSSRule(".marking");
b=k.val();a.style.width=b+"px";a.style.height=b+"px";a.style.marginLeft=-b/2+"px";return a.style.marginTop=-b/2+"px"};B=function(b){var c;c=a.offset();return{x:b.pageX-c.left,y:b.pageY-c.top}};C=function(b){b=B(b);return{x:Math.round(b.x/a.width()*m.width)+n.x,y:Math.round(b.y/a.height()*m.height)+n.y}};v=function(){var a,b;a=f.val();a/=128;1>a?b=1:(b=2-a,a=1);jq("#mainCanvas").css("opacity",b);return jq("#filteredCanvas").css("opacity",a)};w=function(a){u(a,F());return y()};F=function(){return jq("input:radio[name=markingType]:checked").val()};
u=function(c,d){var e;e=new b(c,d);p.push(e);i.append(e.el);e.updateScreenPos(m,a,n);return z()};M=function(a){if(a=P(a.x,a.y))return p=_.without(p,a),a.el.remove(),z(),y()};G=function(){var a,b,c;for(b=0,c=p.length;b<c;b++)a=p[b],a.el.remove();p=[];return z()};z=function(){var a,b,c,d,f,h;b=_.groupBy(p,"type");a=function(a){var c,d;return null!=(c=null!=(d=b[a])?d.length:void 0)?c:0};h=[];for(d=0,f=e.length;d<f;d++)c=e[d],h.push(jq("#cellCount"+c).text(a(c)));return h};P=function(a,b){return _.min(p,
function(c){var d;d=c.pos.x-a;c=c.pos.y-b;return d*d+c*c})};J=function(a){var b;b=new FileReader;b.onload=function(b){I(b.target.result);return A=a.name};return b.readAsDataURL(a)};I=function(a){var b;s.hide("slow");b=new Image;b.onload=function(){return L(b)};return b.src=a};L=function(a){n={x:0,y:0,width:a.width,height:a.height};H=a;m.width=a.width;m.height=a.height;x.drawImage(a,0,0);Q();return D()};D=function(){var a;E.width=m.width;E.height=m.height;a=Filters.filterCanvas(Filters.thresholdRG,
m,{threshold:r.val()});return O.putImageData(a,0,0)};window.FileReader||(alert("No local file reading possible. "+d),jq("#openFile").replaceWith("No local file reading possible. "+a.html()));(function(){var a;if(a=localStorage.cell_counter_settings)a=JSON.parse(a),e=a.enabledMarkingTypes||["0","1"],r.val(a.threshold),k.val(a.markingsSize),f.val(a.fadeThresholdImage),K(),v();return t()})();g(t);t();(function(){var a;a=jq("#openFile");return a.change(function(){var b;b=a.get(0).files;return J(b[0])})})();
(function(){return i.bind("dragover",function(){return!1}).bind("dragleave",function(){m.className="";return!1}).bind("drop",function(a){m.className="";a.preventDefault();if(0<a.originalEvent.dataTransfer.files.length)return J(a.originalEvent.dataTransfer.files[0]);if(c)return 1})})();(function(){i.click(function(a){var b;if("marking"===h)return b=C(a),a.ctrlKey&&0<p.length?M(b):w(b)});return i.bind("contextmenu",function(a){a.preventDefault();return M(C(a))})})();(function(){return $("#autoCountButton").click(function(){var a,
b,c,d,e;G();a=Filters.compressedGrayScaleFromRed(x.getImageData(0,0,m.width,m.height));a=Filters.meanCGSRepeated(a,4,4);a=Filters.peaksCGS(a,r.val(),3);b=F();e=a.peaks;for(c=0,d=e.length;c<d;c++)a=e[c],u({x:a.x+n.x,y:a.y+n.y},b);return y()})})();(function(){var b,c,d,e,f,k,g;c=$("#helpText");b=$("#cropSelection");f=g=null;$("#cropImageLink").click(function(){g=[];h="crop";c.text("Select the top left point!");return c.show("slow")});i.mousemove(function(a){var c;if("crop"===h&&1===g.length)return c=
B(a),a=c.x-f.x,c=c.y-f.y,b.css({width:a+"px",height:c+"px"})});i.click(function(a){var e;if("crop"===h){e=B(a);b.css({top:e.y,left:e.x,width:"5px",height:"5px"}).show();f=e;g.push(C(a));if(1===g.length)return c.text("Select the bottom right point!");if(1<g.length)return c.hide(),b.hide("slow"),h="marking",k(),d()}});k=function(){var a;if(g[1].x<g[0].x)a=g[0].x,g[0].x=g[1].x,g[1].x=a;if(g[1].y<g[0].y)return a=g[0].y,g[0].y=g[1].y,g[1].y=a};d=function(){var a,b,c;c=g[1].x-g[0].x;b=g[1].y-g[0].y;a=x.getImageData(g[0].x-
n.x,g[0].y-n.y,c,b);n={x:g[0].x,y:g[0].y,width:c,height:b};m.width=c;m.height=b;x.putImageData(a,0,0);D();e();return s.show("slow")};e=function(){var b,c,d,e,f,g;for(d=0,e=p.length;d<e;d++)b=p[d],c=b.pos,n.x<=(f=c.x)&&f<n.x+m.width&&n.y<=(g=c.y)&&g<n.y+m.height?b.updateScreenPos(m,a,n):(b.el.remove(),b.removed=!0);e=[];for(c=0,d=p.length;c<d;c++)b=p[c],b.removed||e.push(b);p=e;y();return z()};return s.click(function(){s.hide("slow");return L(H)})})();(function(){var a,b;a=function(a,b){return a.hide().rangeinput().change(function(){N();
return b()})};b=function(b,c){return a(b,c).bind("onSlide",c)};k=b(k,K);r=a(r,D);return f=b(f,v)})();I("images/nora1.jpg");(function(){return jq(window).resize(function(){var b,c,d,e;e=[];for(c=0,d=p.length;c<d;c++)b=p[c],e.push(b.updateScreenPos(m,a,n));return e})})();$("#removeAllMarkings").click(function(){G();return y()});return $("#filterButton").click(function(){var a;a=Filters.filterCanvas(Filters.fastGaussian,m,[0,-1,0,-1,5,-1,0,-1,0]);return x.putImageData(a,0,0)})};g=function(b){var c;c=
$("#enabledMarkingTypesSelector");$("#configureLink").click(function(){var b,d,f,g,h;c.empty();h=[];for(f=0,g=a.length;f<g;f++)d=a[f],b=0<=j.call(e,d)?"checked":"",b='<div>\n<input id="enableMarkingType'+d+'" type="checkbox" value="'+d+'" '+b+'>\n<label for="enableMarkingType'+d+'" class="markingLabel'+d+'">Cell Type '+d+"</label>\n                             </div>",h.push(c.append(b));return h}).overlay({mask:{color:"#ebecff",loadSpeed:200,opacity:0.98},closeOnClick:!1});return jq("#configureOKButton").click(function(){e=
[];$("input:checked",c).each(function(a,b){return e.push($(b).val())});return b()})};d="Your browser is too old. Please use a newer version of firefox, google chrome or opera.";jq(function(){if(isCanvasSupported())return f();jq("#openFile").hide();return alert(d)})}).call(this);
