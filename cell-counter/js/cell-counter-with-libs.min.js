...
Filters.convolute=function(d,c,a){for(var b=Math.round(Math.sqrt(c.length)),e=Math.floor(b/2),g=d.data,k=d.width,d=d.height,o=Filters.createImageData(k,d),h=o.data,a=a?1:0,i=0;i<d;i++)for(var l=0;l<k;l++){for(var f=i,m=l,j=4*(i*k+l),n=0,t=0,w=0,u=0,s=0;s<b;s++)for(var x=0;x<b;x++){var p=f+s-e,q=m+x-e;0<=p&&p<d&&0<=q&&q<k&&(p=4*(p*k+q),q=c[s*b+x],n+=g[p]*q,t+=g[p+1]*q,w+=g[p+2]*q,u+=g[p+3]*q)}h[j]=n;h[j+1]=t;h[j+2]=w;h[j+3]=u+a*(255-u)}return o};
...
B,z,A,y;i=jq("#threshold");c=jq("#fadeThresholdImage");h=jq("#markingsSize");t=null;b=jq("#mainCanvas");f=b.get(0);s=jq("#filteredCanvas").get(0);j=f.getContext("2d");n=s.getContext("2d");r=[];e=jq("#markings");B=function(){var v,a;v=getCSSRule(".marking");a=h.val();v.style.width=a+"px";v.style.height=a+"px";v.style.marginLeft=-a/2+"px";return v.style.marginTop=-a/2+"px"};w=function(v){var a;a=b.offset();return{x:v.pageX-a.left,y:v.pageY-a.top}};m=function(){var a,b;a=c.val();a/=128;1>a?b=1:(b=2-
a,a=1);jq("#mainCanvas").css("opacity",b);return jq("#filteredCanvas").css("opacity",a)};l=function(a){var b;b=jq("input:radio[name=markingColor]:checked").val();a=new d(a,b);r.push(a);e.append(a.el);return y()};A=function(a){if(a=x(a.x,a.y))return r=_.without(r,a),a.el.remove(),y()};z=function(){var a,b,c;for(b=0,c=r.length;b<c;b++)a=r[b],a.el.remove();r=[];return y()};y=function(){var a,b;b=_.groupBy(r,"type");a=function(a){var c,d;return null!=(c=null!=(d=b[a])?d.length:void 0)?c:0};jq("#cellCount0").text(a(0));
return jq("#cellCount1").text(a(1))};x=function(a,b){return _.min(r,function(c){var d;d=c.pos.x-a;c=c.pos.y-b;return d*d+c*c})};p=function(a){var b;z();b=new Image;b.onload=function(){t=b;f.width=b.width;f.height=b.height;j.drawImage(b,0,0);return u()};return b.src=a};q=function(a){var b;b=new FileReader;b.onload=function(a){return p(a.target.result)};return b.readAsDataURL(a)};u=function(){var a;s.width=t.width;s.height=t.height;a=Filters.filterCanvas(Filters.thresholdRG,f,{threshold:i.val()});return n.putImageData(a,
0,0)};(function(){var a;a=jq("#openFile");return a.change(function(){var b;b=a.get(0).files;return q(b[0])})})();(function(){return e.bind("dragover",function(){return!1}).bind("dragleave",function(){f.className="";return!1}).bind("drop",function(b){f.className="";b.preventDefault();if(0<b.originalEvent.dataTransfer.files.length)return q(b.originalEvent.dataTransfer.files[0]);if(a)return log("nada")})})();(function(){e.click(function(a){var b;b=w(a);return a.ctrlKey&&0<r.length?A(b):l(b)});return e.bind("contextmenu",
function(a){a.preventDefault();return A(w(a))})})();(function(){var a,b;a=function(a,b){return a.hide().rangeinput().change(b)};b=function(b,c){return a(b,c).bind("onSlide",c)};h=b(h,B);i=a(i,u);return c=b(c,m)})();p("images/nora1.jpg");jq("#removeAllMarkings").click(z);return jq("#filterButton").click(function(){var a;a=Filters.filterCanvas(Filters.fastGaussian,f,[0,-1,0,-1,5,-1,0,-1,0]);return j.putImageData(a,0,0)})};c=function(){if("undefined"===typeof window.FileReader)return alert("No local file reading possible. Please use a newer version of firefox or google chrome")};
jq(function(){c();return b()})}).call(this);
